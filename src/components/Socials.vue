<template>
    <main class="flex flex-col">
        ...
        <p class="mb-12 font-bold text-primary">For mer seriøse henveldelser skyt meg en epost på <a class="underline text-secondary" href="mailto:lahnzki@gmail.com">lahnzki@gmail.com</a>, så tar jeg kontakt når det passer. </p>
    </main>
</template>
