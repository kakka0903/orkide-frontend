<template>
    <main class="flex flex-col font-bold">
        <PageHeading
            title="LAHN CINEMA"
            description="Get a ticket and enjoy"
        />
        <p class="mb-10 text-primary">
            Music videos filmed, edited and directed by
            <span class="text-secondary">Magnus “Lahnzki” Lahn</span>
            under the <span class="text-secondary">orkide</span> name.
        </p>
